    ...
    public partial class SeedingData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeTile", "This is home page of eShopSolution" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2020, 10, 25, 20, 59, 50, 165, DateTimeKind.Local).AddTicks(8348), null, 100000m, 200000m },
                    { 2, new DateTime(2020, 10, 25, 20, 59, 50, 166, DateTimeKind.Local).AddTicks(8092), null, 100000m, 200000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Áo sơ mi nam trắng Việt Tiến", "Áo sơ mi nam trắng Việt Tiến", "vi-VN", "Áo sơ mi nam trắng Việt Tiến", 2, "ao-nam", "ao-so-mi-nam-tran-viet-tien", "Sản phẩm áo thời trang nam" },
                    { 4, "Viet Tien Men T-Shirt", "Viet Tien Men T-Shirt", "en-US", "Viet Tien Men T-Shirt", 2, "viet-tien-men-t-shirt", "Viet Tien Men T-Shirt", "Viet Tien Men T-Shirt" }
                });
        }
